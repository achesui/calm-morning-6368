...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/calm-morning-6368
```

A live public deployment of this template is available at [https://calm-morning-6368.templates.workers.dev](https://calm-morning-6368.templates.workers.dev)
